# Differential-backup-and-differential-download-between-WSL-and-Google-Drive
...
Note:
They do not have an extension to make them easier to use as commands after exporting them to environment variables.
